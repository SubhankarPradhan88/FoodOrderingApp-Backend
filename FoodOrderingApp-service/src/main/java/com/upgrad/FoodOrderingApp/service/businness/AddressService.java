...
public class AddressService {
    ...
    public AddressEntity getAddressByUUID(String addressId, CustomerEntity customerEntity)
        ...
        try { // Throw error if addressId is null
            ...
            //Calls getAddressById method of addressDao to get addressEntity
     ...
     */
    @Transactional(propagation = Propagation.REQUIRED)
    public AddressEntity deactivateAddress(AddressEntity address) {
    ...
    public StateEntity getStateByUUID(String stateUUID) throws AddressNotFoundException {
        ...
        StateEntity stateEntity = stateDao.findStateByUUID(stateUUID);
        if (stateEntity == null) { // Throw error if State not found
     ...
     */
    public boolean addressFieldsEmpty(AddressEntity address) {
