...
public class CustomerService {
    ...
    public CustomerAuthTokenEntity getCustomerAuthEntity(String accessToken) throws AuthorizationFailedException {
    ...
    public CustomerEntity getCustomer(final String accessToken) throws AuthorizationFailedException {
        final CustomerAuthTokenEntity customerAuthEntity =
